...
void main() {
  test('VmClient watches the vmservice-out-file and attempts to connect when it changes', () async {
  ...
  test('does not open duplicate connections when several events fire for one write', () async {
